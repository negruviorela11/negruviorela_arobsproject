...
<div>
     <table class="table table-hover">
        ...
        <tr>
            ...
            <td class="actions">
                ...
                <a href="#" class="deletemess1" id="{{'deletemess1_'.$key}}"><span class="glyphicon glyphicon-trash" data-toggle="modal" data-target="#myModal" title="Delete Message"</span></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </td>
        </tr>
        <?php } ?>
    </table>
    ...
    <div class="modal-content">
     ...
     <a href="#" id="confdeletemess1" class="btn btn-primary">YES</a>
