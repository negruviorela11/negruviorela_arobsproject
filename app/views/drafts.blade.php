...
<div>
        ...
        <tr class="info">
            ...
            <?php foreach ($draftEmail as $key=>$email){?>
            <tr>
                <td>
                    <?php echo $email[0];?>
                </td>
                ...
                <a href="#" class="deletemess3" id="{{'deletemess3_'.$key}}"><span class="glyphicon glyphicon-trash" data-toggle="modal" data-target="#myModal" title="Delete Message"</span></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                </td>
            </tr>
            <?php } ?>
        </table>
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
     ...
     <a href="#" id="confdeletemess3" class="btn btn-primary">YES</a>
